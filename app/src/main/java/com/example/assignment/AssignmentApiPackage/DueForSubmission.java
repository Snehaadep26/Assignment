...
public class DueForSubmission {
    ...
    public DueForSubmission(int id, String title, Date dueDate, String status, String type, Date publishDate, String subjectName, String subjectIcon, Object assignmentStudentId, Object returnedDate, String teacherName, String noOfQuestions, String marks, String countAttempted) {
        this.id = id;
        this.title = title;
